...
# Test cases from anchorman_langgraph_test.py
TEST_QUERIES = [
    ("show me the financial headlines today", "anchorman"),
    ("what's happening in technology?", "anchorman"),
    ("give me the latest sports news", "anchorman")
]

def test_chat_endpoint():
    """
    Test the chat API endpoint with various queries
    """
